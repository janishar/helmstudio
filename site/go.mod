module github.com/janishar/helmstudio/site

go 1.27.1

require (
	github.com/janishar/helmstudio v1.0.0-rc.4
	github.com/janishar/helmstudio/packages/helm-runtime-sdk/go v1.0.0-rc.4
	github.com/janishar/helmstudio/packages/helm-runtime-sdk/go/embedded v1.0.0-rc.4
