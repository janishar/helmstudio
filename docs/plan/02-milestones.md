...
| M9 | Mac app and release — native shell, handshake, browser auth and CSRF, signing, notarisation (notes: 2026-09-16, taken after M10; 2026-09-18, native rather than Electron — both by the human's decision) | 7–9d | **all of it** |
